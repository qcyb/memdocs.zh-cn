...
## <a name="compliance-policy-settings"></a>符合性策略设置
...
- **增强型越狱检测**（仅适用于 iOS/iPadOS）
  ...
  - **已启用**：此安全功能已启用。 接收设备符合性策略以阻止越狱设备的设备使用增强型越狱检测。
...
## <a name="device-compliance-policies"></a>设备符合性策略
...
- [监视设备符合性](../protect/compliance-policy-monitor.md)
