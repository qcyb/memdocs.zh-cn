...
Outlook 提供“个人”和“公司”电子邮件的电子邮件组合视图。 在这种情况下，Outlook 应用会在启动时提示输入 Intune PIN。
  ...
  >[!NOTE]
  > 尽管 Edge 在“公司”上下文中，但用户可以有意将 OneDrive“公司”上下文文件移动到未知的个人云存储位置。 若要避免这种情况，请参阅[管理受限网站](manage-microsoft-edge.md#manage-restricted-web-sites)，并为 Edge 配置允许/阻止的站点列表。
