...
- [注册 macOS 虚拟机时出错](unable-to-get-macOS-device-managed.md)  
- [收到一条 macOS 设备序列号受到限制的消息](unable-to-get-macOS-device-managed.md)  
- [设备可能已分配给其他人](unable-to-get-macOS-device-managed.md)  
