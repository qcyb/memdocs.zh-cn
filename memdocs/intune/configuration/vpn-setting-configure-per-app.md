...
VPN 配置文件包含附带客户端凭据的 SCEP 或 PKCS 证书、VPN 的连接信息以及每应用 VPN 标志，用于启用供 iOS/iPadOS 应用程序使用的每应用 VPN 功能。
...
4. 选择“基础 VPN”  。 [iOS/iPadOS VPN 设置](vpn-settings-ios.md)列出并介绍了所有设置。 使用每应用 VPN 时，请确保设置列出的以下属性：
