...
| Intune 是否可以支持 Win32 应用预安装？  | 是的。  从 Windows 10 十月更新 (版本 1809) 开始，Intune 支持使用 .msi 和 .msix 包装的 Win32 应用。  |
...
| MBR 或映像重新安装后，Windows Autopilot 是否正常工作？ | 是的。 有关详细信息，请参阅[Windows Autopilot 主板更换方案指南](autopilot-mbr.md)。 |
