...
description: 了解 Configuration Manager 版本 1706 收集的诊断和使用情况数据的级别。
ms.date: 07/31/2017
...
Configuration Manager 版本 1706 收集三个级别的诊断和使用情况数据：“基本”、“增强”和“完全”    。 默认情况下，此功能设置为增强级别。 以下部分提供有关每个级别所收集数据的其他详细信息。
...
对于 Configuration Manager 版本 1706，此级别包括以下内容：
