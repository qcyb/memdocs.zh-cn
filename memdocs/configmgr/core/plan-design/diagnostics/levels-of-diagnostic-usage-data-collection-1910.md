---
title: 1910 的诊断和使用情况数据
titleSuffix: Configuration Manager
description: 了解 1910 版 Configuration Manager 在每个级别收集的特定数据。
ms.date: 11/29/2019
...
ms.locfileid: "88128597"
---
# <a name="diagnostic-and-usage-data-for-version-1910"></a>版本 1910 的诊断和使用情况数据
...
对于 Configuration Manager 版本 1910，此级别包括以下数据：
...
- ***[新增]*** 有关 Office 外接程序运行状况的聚合统计信息

- ***[新增]*** Office Pro Plus 试点集合的计数和大小
