...
description: 了解 Configuration Manager 版本 1702 收集的诊断和使用情况数据的级别。
ms.date: 03/27/2017
...
ms.locfileid: "88994814"
---
# <a name="levels-of-diagnostic-usage-data-collection-for-version-1702-of-configuration-manager"></a>Configuration Manager 版本 1702 收集的诊断使用情况数据的级别

适用范围：  Configuration Manager (Current Branch)

Configuration Manager 版本 1702 收集三个级别的诊断和使用情况数据：“基本”、“增强”和“完全”    。 默认情况下，此功能设置为增强级别。 以下部分提供有关每个级别所收集数据的其他详细信息。
...
对于 Configuration Manager 版本 1702，此级别包括以下内容：
