---
title: 版本 2006 收集的诊断和使用情况数据
titleSuffix: Configuration Manager
description: 了解 Configuration Manager 版本 2006 在每个级别收集的具体数据。
ms.date: 08/11/2020
...
ms.locfileid: "88129509"
---
# <a name="diagnostic-and-usage-data-for-version-2006"></a>版本 2006 收集的诊断和使用情况数据
...
对于 Configuration Manager 版本 2006，此级别包括以下数据：
...
- 基本 Configuration Manager 站点层次结构数据：站点列表、类型、版本、状态、客户端计数、时区和运行状况
...
- 共同管理的聚合使用情况统计信息：已注册的客户端数、注册客户端数、待注册客户端数、接收策略的客户端、工作负载状态、试验/排除收集大小和注册错误  
...
- Configuration Manager 控制台故障位置

- Configuration Manager 控制台使用情况统计信息
...
- [已移动] 云管理网关的配置和使用情况统计信息：区域和环境计数，以及身份验证/授权统计信息  

- [已移动] SQL AlwaysOn 副本信息、使用情况和运行状况  
...
- 使用仪表板创建的 Microsoft 365 Apps 应用程序计数  
...
- 有关 Office 加载项、Office Readiness Toolkit 的使用以及装有 Microsoft 365 Apps 的客户端计数的聚合统计信息

- 有关 Office 外接程序运行状况的聚合统计信息

- Office Pro Plus 试点集合的计数和大小

- 发送 Office 运行状况数据的 Office 专业增强版设备数
...
- [新增] 部署的符合性设置计数（按类别、OS 和源（云与本地）划分）
...
- Microsoft Defender 高级威胁防护策略的聚合统计信息
