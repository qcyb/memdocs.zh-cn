...
description: 了解如何在命令提示符处运行 Configuration Manager 安装程序来安装多个站点。
ms.date: 03/27/2017
...
ms.locfileid: "81700395"
---
# <a name="use-a-command-line-to-install-configuration-manager-sites"></a>使用命令行安装 Configuration Manager 站点

适用范围：  Configuration Manager (Current Branch)

 可在命令提示符处运行 Configuration Manager 安装程序来安装多个站点类型。
...
有关详细信息，请参阅 [Configuration Manager 的无人参与站点恢复](../../manage/unattended-recovery.md)。  
...
请参阅[命令行选项](command-line-options-for-setup.md)获取有关如何在脚本文件中使用此密钥名称的信息。
