...
ms.locfileid: "81700955"
---
# <a name="select-discovery-methods-to-use-for-configuration-manager"></a>选择 Configuration Manager 要使用的发现方法

适用范围：  Configuration Manager (Current Branch)

若要成功且有效地使用 Configuration Manager 的发现，必须考虑使用哪些方法以及在哪些站点运行它们。  
 ...
 有关其他发现方法的信息，请参阅[关于 Configuration Manager 的发现方法](../../../../core/servers/deploy/configure/about-discovery-methods.md)。  
...
##  <a name="discovery-data-is-shared-among-sites"></a><a name="bkmk_shared"></a>发现数据在站点之间共享  
...
##  <a name="best-practices-for-discovery"></a><a name="bkmk_best"></a>最佳发现方案  
