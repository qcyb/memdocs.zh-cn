...
ms.locfileid: "89608191"
---
# <a name="checklist-for-installing-update-2006-for-configuration-manager"></a>用于安装 Configuration Manager 更新 2006 的清单

适用范围：  Configuration Manager (Current Branch)

使用 Configuration Manager Current Branch 时，可以为版本 2006 安装控制台内更新，以便从旧版本更新层次结构。 <!-- baseline only statement:Version 2006 is also available as [baseline media](updates.md#bkmk_Baselines), so you can use the installation media to install the first site of a new hierarchy.-->

若要获取版本 2006 的更新，必须在层次结构的顶级站点上使用服务连接点。 站点系统角色可处于任一模式（联机或脱机）。 若要在服务连接点脱机时下载更新，请[使用服务连接工具](use-the-service-connection-tool.md)。<!-- SCCMDocs#1946 -->
...
层次结构中的每个站点服务器都必须运行相同版本的 Configuration Manager，然后你才能开始安装更新 2006。 若要更新到 2006，必须使用版本 1810 或更高版本。
