...
使用 Configuration Manager 的 Current Branch 时，可安装版本为 1902 的控制台内部更新，从之前的版本更新层次结构。 <!-- baseline only statement:-->（由于版本 1902 也可用作[基线介质](updates.md#bkmk_Baselines)，因此，可使用该安装介质安装新层次结构的第一个站点。）
