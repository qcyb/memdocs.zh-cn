...
description: 将更新重置工具用于 Configuration Manager 的控制台中更新。
ms.date: 07/31/2017
...
[控制台中更新](install-in-console-updates.md)尚未安装且处于失败状态时，使用此工具。 失败状态表示更新下载正在进行，但是处于停滞状态，或者花费的时间过长。 时间过长是指小时数大于对同等大小的更新包的历史预期。 另外，也可能是无法将更新复制到子主站点。  
