---
title: 1710 的清单 | Configuration Manager
titleSuffix: Configuration Manager
description: 了解更新到 Configuration Manager 版本 1710 之前需要执行的操作。
ms.date: 12/19/2017
...
ms.locfileid: "81707745"
---
# <a name="checklist-for-installing-update-1710-for-configuration-manager"></a>用于为 Configuration Manager 安装更新 1710 的清单

适用范围：  Configuration Manager (Current Branch)

使用 Configuration Manager 的 Current Branch 时，可安装版本为 1710 的控制台内部更新，从之前的版本更新层次结构。

若要获取版本 1710 的更新，必须在层次结构的顶层站点上使用服务连接点站点系统角色。 其可处于联机或脱机模式。 层次结构从 Microsoft 下载更新包之后，可在“管理”&gt;“概述”&gt;“云服务”&gt;“更新和维护服务”  下的控制台中找到它。

-   当更新列为“可用”  时，此更新即可准备安装。 安装版本 1710, 之前，请查看以下[关于安装更新 1710](#about-installing-update-1710) 和[清单](#checklist)信息，了解在开始更新之前要进行的配置。
...
## <a name="about-installing-update-1710"></a>关于安装更新 1710

**站点：**  
在层次结构的顶层站点上安装更新 1710。 这意味着你需要从管理中心站点（如果有）或从独立主站点启动安装。 在顶层站点安装更新后，子站点具有以下更新行为：
...
**确保所有站点都运行支持更新到 1710 的Configuration Manager 版本：**    
层次结构中的每个站点服务器都必须运行相同的 Configuration Manager 版本，然后才能开始安装更新 1710。 若要更新到 1710，必须使用版本 1610、1702 或 1706。

**查看软件保障的状态或等效订阅权限：**    
必须具有有效的软件保障 (SA) 协议才能安装更新 1710。 安装此更新时，“许可”  选项卡将出现确认“软件保障到期日期”  的选项。
...
如果在更新 Windows ADK 前更新站点，请参阅[利用启动映像更新分发点](../../../osd/get-started/manage-boot-images.md#update-distribution-points-with-the-boot-image)，了解 Configuration Manager 1710 版中对此过程的改进。
...
有关详细信息，请参阅 [监视数据库复制](monitor-replication.md#BKMK_RLA)主题中的[复制链接分析器](monitor-replication.md#BKMK_RLA)。
...
2. 确保每个站点服务器和站点系统角色都已更新为版本 1710。 在控制台中，你可以将可选列“版本”  添加到某些节点的显示，包括“站点”  和“分发点”  。
