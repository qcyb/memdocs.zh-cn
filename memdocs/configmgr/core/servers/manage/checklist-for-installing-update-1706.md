...
description: 了解更新到 Configuration Manager 版本 1706 之前需要执行的操作。
ms.date: 12/19/2017
...
ms.locfileid: "81707725"
---
# <a name="checklist-for-installing-update-1706-for-configuration-manager"></a>用于为 Configuration Manager 安装更新 1706 的清单

适用范围：  Configuration Manager (Current Branch)

使用 Configuration Manager 的 Current Branch 时，可安装版本为 1706 的控制台内部更新，从之前的版本更新层次结构。
...
**确保所有站点都运行支持更新到 1706 的 Configuration Manager 版本：**    
层次结构中的每个站点服务器都必须运行相同的 Configuration Manager 版本，然后才能开始安装更新 1706。 若要更新到 1706，必须使用版本 1606、1610 或 1702。
...
如果在更新 Windows ADK 前更新站点，请参阅[利用启动映像更新分发点](../../../osd/get-started/manage-boot-images.md#update-distribution-points-with-the-boot-image)，了解 Configuration Manager 1706 版中对此过程的改进。
...
**更新站点：** 现已准备好可以为层次结构开始更新安装。 有关安装更新的详细信息，请参阅[安装控制台内部更新](install-in-console-updates.md#bkmk_install)。
