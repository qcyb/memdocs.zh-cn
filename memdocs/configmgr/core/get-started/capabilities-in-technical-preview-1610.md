...
description: 了解 Configuration Manager Technical Preview（版本 1610）中的可用功能。
ms.date: 01/23/2017
...
本文介绍 Configuration Manager Technical Preview 1610 中提供的功能。 你可以安装此版本，以更新 Technical Preview 站点的功能并向其添加新功能。      在安装此版本的技术预览版前，请查看介绍性主题 [Configuration Manager 的 Technical Preview](../../core/get-started/technical-preview.md)，以熟悉使用技术预览版的常规要求和限制、如何在版本之间进行更新，以及如何提供关于技术预览版中的功能的反馈。    
...
1. 在 Configuration Manager 控制台中，[创建和部署需要批准的应用程序](../../apps/deploy-use/create-applications.md)。
...
- **手动客户端安装** – 可以手动升级排除集合中的客户端，方法是结合使用后列命令行开关和 ccmsetup：***/ignoreskipupgrade***
  ...
  如果尝试在不使用此开关的情况下手动升级排除集合中的客户端，客户端将不会安装新的客户端软件。 有关详细信息，请参阅[如何手动安装 Configuration Manager 客户端](../clients/deploy/deploy-clients-to-windows-computers.md#BKMK_Manual)。

有关客户端安装方法的详细信息，请参阅[如何将客户端部署到 Windows 计算机](../clients/deploy/deploy-clients-to-windows-computers.md)。
