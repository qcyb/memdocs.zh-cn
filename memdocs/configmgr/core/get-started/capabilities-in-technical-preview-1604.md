...
description: 了解 Configuration Manager Technical Preview（版本 1604）中的可用功能。
ms.date: 01/23/2017
...
本文介绍 Configuration Manager Technical Preview 1604 中提供的功能。 你可以安装此版本，以更新 Technical Preview 站点的功能并向其添加新功能。      在安装此版本的技术预览版前，请查看介绍性主题 [Configuration Manager 的 Technical Preview](../../core/get-started/technical-preview.md)，以熟悉使用技术预览版的常规要求和限制、如何在版本之间进行更新，以及如何提供关于技术预览版中的功能的反馈。  

 以下是可以试用的此版本的新功能。  

##  <a name="manage-volume-purchased-apps-from-the-windows-store-for-business"></a><a name="BKMK_WindowsVPP"></a>管理从适用于企业的 Windows 应用商店批量采购的应用  
...
##  <a name="improvements-to-microsoft-passport-for-work-management"></a><a name="BKMK_PFW"></a> 对 Microsoft Passport for Work 管理的改进  
 现在可以将 Passport for Work 策略部署到由 Configuration Manager客户端管理的已加入域的 Windows 10 设备。  

##  <a name="option-for-clients-to-switch-to-a-new-software-update-point"></a><a name="bkmk_switchsup"></a>供客户端切换到新软件更新点的选项  
...
##  <a name="client-settings-to-manage-client-cache-settings-and-client-peer-cache"></a><a name="bkmk_peercache"></a>用于管理客户端缓存设置和客户端对等缓存的客户端设置  
...
##  <a name="support-for-passport-for-work-as-a-ksp"></a><a name="bkmk_passport"></a>支持将 Passport for Work 作为 KSP  
 Configuration Manager 允许集成 Microsoft Passport for Work，它是使用 Active Directory 或 Azure Active Directory 帐户取代密码、智能卡或虚拟智能卡进行登录的一种替代方法。  
...
##  <a name="on-premises-device-health-attestation"></a><a name="bkmk_onpremdha"></a>本地设备运行状况证明  
...
##  <a name="smartlock-setting-for-android-devices"></a><a name="BKMK_Smart"></a>适用于 Android 设备的 SmartLock 设置  
