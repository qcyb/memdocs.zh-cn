...
description: 使用管理员清单，有助于规划和实现 Configuration Manager 中的电源管理。
ms.date: 10/06/2016
...
ms.locfileid: "81696655"
---
# <a name="administrator-checklist-for-power-management-in-configuration-manager"></a>Configuration Manager 中的电源管理的管理员清单

适用范围：  Configuration Manager (Current Branch)

此管理员清单提供了在组织中使用 Configuration Manager 电源管理的建议步骤。  
