...
从版本 2006 开始，如果将公司门户部署到共同管理的设备，请将此设置配置为“公司门户”。 此设置可确保来自 Configuration Manager 和 Intune 的通知都启动公司门户。 如果 Configuration Manager 通知的场景是公司门户不支持的，则选择通知会启动软件中心。

如果将公司门户安装在共同托管设备上，但将此设置配置为“软件中心”，则来自 Configuration Manager 的通知会启动软件中心。 来自 Intune 的通知会启动公司门户。 此行为可能会让用户在与不同的门户交互时感到困惑。
