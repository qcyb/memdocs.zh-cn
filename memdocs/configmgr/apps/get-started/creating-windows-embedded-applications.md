...
ms.locfileid: "81689835"
---
# <a name="create-windows-embedded-applications-with-configuration-manager"></a>使用 Configuration Manager 创建 Windows Embedded 应用程序

适用范围：  Configuration Manager (Current Branch)

除了创建应用程序的其他 Configuration Manager 要求和过程，在创建和部署适用于 Windows Embedded 设备的应用程序时还必须考虑以下注意事项。  
