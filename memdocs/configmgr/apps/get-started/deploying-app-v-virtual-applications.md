...
|评估将对其部署虚拟应用程序的用户和设备。|创建 Configuration Manager 集合以将要对其部署虚拟应用程序的用户和设备组合在一起。 请参阅[集合简介](../../core/clients/manage/collections/introduction-to-collections.md)。|  
|将 App-V 5 连接组迁移到 Configuration Manager 虚拟环境。|请参阅本主题中的[将 App-V 5 连接组迁移到 Configuration Manager 虚拟环境](deploying-app-v-virtual-applications.md#migrating-app-v-5-connection-groups-to-configuration-manager-virtual-environments)部分。|  
...
|创建应用程序以替换现有 APP-V 包。|请参阅[应用程序管理简介](../understand/introduction-to-application-management.md)和[创建应用程序](../../apps/deploy-use/create-applications.md)。|  
...
|Configuration Manager 不再支持使用包含虚拟应用程序的包和程序。 从 Configuration Manager 2007 迁移到 Configuration Manager Current Branch 时，Configuration Manager 会将这些包转换为应用程序。<br /><br /> Configuration Manager 2007 播发将转换为以下部署类型：<br /><br /> - 迁移无播发的 APP-V 包：使用默认部署类型设置的一个部署类型。<br /><br /> - 迁移具有一个播发的 APP-V 包：使用与 Configuration Manager 2007 播发相同的设置的 <br />                一个部署类型。<br /><br /> - 迁移具有多个播发的 APP-V 包：用于每个 <br />                Configuration Manager 2007 播发一个部署类型，该类型使用对应播发的设置。|请参阅[规划将对象迁移到 Configuration Manager Current Branch](../../core/migration/planning-for-the-migration-of-objects.md)。|  
