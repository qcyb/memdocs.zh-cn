...
>
> 如果使用任何其他单独的 CDP，则需要为每个其他 CDP 请求单独的证书。 若要为 CDP 请求公共证书，请使用与云管理网关 CSR 相同的详细信息。 只需更改公用名，使其对每个 CDP 都是唯一的。
>
> 已不推荐使用其他单独的 CDP。 有关详细信息，请参阅[已弃用的功能](../core/plan-design/changes/deprecated/removed-and-deprecated-cmfeatures.md#deprecated-features)。
...
2. 选择“属性”，然后对“分配”选择“编辑”。 选择“必需分配”下方的“添加组”，以设置包含要参与共同管理的用户和设备的 Azure Active Directory (AD) 组 。  
