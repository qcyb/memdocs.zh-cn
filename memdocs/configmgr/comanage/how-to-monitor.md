...
此仪表板可帮助你查看环境中共同管理的计算机。 图形有助于标识可能需要注意的设备。<!--1356648,1358980-->
...
### <a name="co-management-status"></a>共同管理状态
...
| 2149056533 (0x80180015)<br>MENROLL_E_NOTSUPPORTED | 不支持移动设备管理。 检查设备限制。 |
