...
ms.locfileid: "81692385"
---
# <a name="monitor-compliance-settings-in-configuration-manager"></a>监视 Configuration Manager 中的符合性设置

适用范围：  Configuration Manager (Current Branch)

在向层次结构中的设备部署 Configuration Manager 配置基线后，你可以使用本主题中的一个或多个过程来显示配置基线的符合性状态：
