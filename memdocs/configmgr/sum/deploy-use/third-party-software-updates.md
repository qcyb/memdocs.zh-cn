...
- 对于 1910 之前的 Configuration Manager 版本，“软件更新管理员”安全角色无法同步第三方目录。 需要“完全权限管理员”安全角色才能同步目录。
...
2. 选择要订阅的目录，然后单击功能区中的“订阅目录”。 
    ![第三方更新订阅目录](media/third-party-updates-subscribe.png)
3. 查看并批准目录证书。  
   > [!NOTE]
   > 
